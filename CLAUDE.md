...
Estado: prototipo con fases 1–5.25 completadas (movimiento, combate, 4 clases
...
origen, y creacion de personaje/habilidades migradas a i18n). Detalle en
...
- Siguientes candidatos: Zona 4, persistencia de estado en el servidor,
  importar/controlar animaciones reales del pack KayKit, o terminar los textos
  secundarios restantes de i18n.
