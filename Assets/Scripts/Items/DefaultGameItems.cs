...
namespace MmorpgPrototype
{
    ...
    public static class DefaultGameItems
    {
        ...
        public const string SkillTome = "skill_tome";
        ...
        public static List<ItemDefinition> CreateAll()
        {
            var items = new List<ItemDefinition>
            {
                ...
                Basic(SkillTome, "Manual de habilidades", "Enseña y mejora habilidades de combate.", ItemCategory.Material, Rarity.Rare, sellPrice: 65),
        ...
        {
            return new[] { MinorPotion, AncientFragment, WornRing, DullOre, TornScroll, ProtectionRune, SkillTome };
        }
