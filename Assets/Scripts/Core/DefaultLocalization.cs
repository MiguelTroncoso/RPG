    ...
    public static class DefaultLocalization
    {
        public static Dictionary<string, string> CreateSpanish()
        {
            return new Dictionary<string, string>
            {
                ...
                { "hud.controls_help", "WASD/joystick moverse  |  ATK/Space ataque  |  Q/E/R/F habilidades  |  Click derecho camara" },
                { "hud.touch_help", "Joystick mover  |  Arrastra el mundo: camara  |  ATK atacar  |  Q/E/R/F habilidades" },
                { "ui.minimap", "MINIMAPA" },
