...
namespace MmorpgPrototype
{
    ...
    public static class DefaultZones
    {
        ...
        public static ZoneDefinition CreateZone1()
        {
            ...
            zone.MinLevel = 1;
            zone.MaxLevel = 10;
            zone.GroundCenter = Vector3.zero;
            zone.GroundColor = new Color(0.2f, 0.34f, 0.28f);
            zone.SignPosition = new Vector3(0f, 0f, -9.5f);
            zone.HasSafeZone = true;
            zone.SafeZoneCenter = new Vector3(0f, 0f, -3f);
            zone.SafeZoneRadius = 9.5f;
            zone.NormalEnemyId = "valley_creature";
            zone.NormalName = "Lobo corrupto";
            zone.NormalColor = new Color(0.72f, 0.17f, 0.15f);
            zone.NormalCount = 5;
            zone.NormalAreaCenter = new Vector3(0f, 1f, 16f);
            zone.NormalAreaRadius = 6.5f;
            zone.NormalHealth = 90;
            zone.NormalDamage = 8;
            zone.NormalExp = 34;
            zone.NormalGoldMin = 3;
            zone.NormalGoldMax = 9;
            zone.NormalMoveSpeed = 2.2f;
            zone.EliteAreaCenter = new Vector3(18f, 1f, 16f);
            zone.EliteAreaRadius = 5f;
            zone.BossPosition = new Vector3(-22f, 1f, 22f);
