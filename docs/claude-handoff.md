...
3. README.md (historial de fases 1 a 5.39 y como ejecutar).
4. El codigo existente relacionado con tu tarea.

Estado actual (fases 1-5.39 completadas; hoja de ruta A-K completa):
...
- Android: `AndroidBuildTools` deja ARM64, SDK minimo 26, target SDK 35,
  landscape e identificador configurados. La build debug fue intentada en
  batch y se detuvo porque falta `PlaybackEngines/AndroidPlayer`.
...
- Instalar Android Build Support, generar APK debug y probar en un telefono.
